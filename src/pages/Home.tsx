    ...
    <>
      ...
      <section className="hero-section">
        ...
        <h1 className="hero-headline">
          Hacker News, <span className="hero-headline-accent">Refined.</span>
        </h1>

        <p className="hero-sub">
          A beautiful iOS reader built for the way you actually consume tech
          news. Liquid glass aesthetic, curated content, full comment threads.
        </p>

        <div className="hero-actions">
          <a
            href="https://apps.apple.com/au/app/liquidnews/id6762944857"
